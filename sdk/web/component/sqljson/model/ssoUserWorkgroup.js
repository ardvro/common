var ssoUserWorkgroup = function ssoUserWorkgroup()
{
    this.Name = "ssoUserWorkgroup";
    this.Label = "User Workgroup";
    this.Columns = [
        {
    ...
    this.Associations = [
        {
            Name: "ssoUserWorkgroupRoles",
            Label: "User Workgroup Roles",
            Schema: "ssoUserWorkgroupRole"
        }
    ];
};

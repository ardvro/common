var FuzzySetting = function FuzzyFuzzySetting()
{
    this.Name = "FuzzySetting";
    this.Label = "FuzzySetting";
    this.Columns = [
        {
    ...
    this.Associations = [
        {
            Name: "FuzzySettingItems",
            Label: "FuzzySettingItems",
            Schema: "FuzzySettingItem"
        }
    ];
};